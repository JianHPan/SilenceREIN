...
def figure2(values, values2, values3, figurename='Figure2'):
    ...
    for x1, y1 in enumerate(means['SilenceREIN-alt']):
        ...
        if x1 == 5:
            y1 += 0.01
        plt.text(x1 - 0.15, y1 + 0.005, f"{a}±{b}", ha='center', va='bottom', fontsize=fontsize,
                 rotation=45, font=font, fontweight='bold')
...
if __name__ == '__main__':
    # HepG2------------------------------------------------------------------
    value2 = {}
    filenames_SilenceREIN = ['data/FigureS2/SilenceREIN-HepG2-0.json',
                             'data/FigureS2/SilenceREIN-HepG2-1.json',
                             'data/FigureS2/SilenceREIN-HepG2-2.json',
                             'data/FigureS2/SilenceREIN-HepG2-3.json',
                             'data/FigureS2/SilenceREIN-HepG2-4.json',
                             ]
    ...
    filenames_SilenceREIN_alt = ['data/FigureS2/SilenceREIN-alt-HepG2-0.json',
                                 'data/FigureS2/SilenceREIN-alt-HepG2-1.json',
                                 'data/FigureS2/SilenceREIN-alt-HepG2-2.json',
                                 'data/FigureS2/SilenceREIN-alt-HepG2-3.json',
                                 'data/FigureS2/SilenceREIN-alt-HepG2-4.json',
                                 ]
    ...
    figure2(values, value2, value3, figurename='FigureS2')
