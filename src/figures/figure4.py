...
def figure4(values2):
    ...
    plt.savefig('Figure4.svg', format='SVG', dpi=1200)
    plt.show()
...
if __name__ == '__main__':
    ...
    filenames_SilenceREIN_alt = [
        'data/SilenceREIN-alt-K562-ChIA-PET-0.json',
        'data/SilenceREIN-alt-K562-ChIA-PET-1.json',
        'data/SilenceREIN-alt-K562-ChIA-PET-2.json',
        'data/SilenceREIN-alt-K562-ChIA-PET-3.json',
        'data/SilenceREIN-alt-K562-ChIA-PET-4.json',
    ]
    ...
    y_ture_list, _, y_score_list = get_y_ture_y_pred_y_score(filenames_SilenceREIN_alt)
